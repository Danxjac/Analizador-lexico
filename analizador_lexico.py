...
inputPrograma = input("inserta tu codigo: ");
inputPrograma_tokens = nltk.wordpunct_tokenize(inputPrograma);

print(inputPrograma_tokens);
...
for token in inputPrograma_tokens:
